 ...
 */
@Component({
  selector: 'app-table-guarantor',
  templateUrl: './table-guarantor.component.html',
  styleUrls: ['./table-guarantor.component.css']
})
export class TableGuarantorComponent implements OnInit {
