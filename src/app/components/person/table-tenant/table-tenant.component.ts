 ...
 */
@Component({
  selector: 'app-table-tenant',
  templateUrl: './table-tenant.component.html',
  styleUrls: ['./table-tenant.component.css']
})
export class TableTenantComponent implements OnInit {
